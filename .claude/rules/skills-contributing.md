...
This fork is kept down to skills that generate or maintain specs: `spec-driven-development`, `documentation-and-adrs`, and `spec-corpus-hygiene`. Before creating a new `skills/<name>/` directory or significantly reworking an existing one:
