...
A trimmed fork of [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) kept down to the two skills that generate and maintain specs: writing a structured spec before code, and recording the decisions and documentation that keep it accurate afterward.
...
Skills also activate automatically based on what you're doing — starting a project with no spec triggers `spec-driven-development`, making an architectural decision or shipping a feature triggers `documentation-and-adrs`.
